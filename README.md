...
- Create a copy of ``github_integration/settings/local.py.example``:
  `cp github_integration/settings/local.py.example github_integration/settings/local.py` (remembering you should replace `github_integration` with your project's name!).
...
- Run postgres using `docker-compose up`
- `pipenv shell`
